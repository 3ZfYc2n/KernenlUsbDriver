...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, WebSecUsbDriverCreateDevice)
#pragma alloc_text (PAGE, WebSecUsbDriverEvtDevicePrepareHardware)
#endif
...
--*/
{
    ...
    if (NT_SUCCESS(status)) {
        ...
        status = WdfDeviceCreateDeviceInterface(
            device,
            &GUID_DEVINTERFACE_WebSecUsbDriver,
...
NTSTATUS
WebSecUsbDriverEvtDevicePrepareHardware(
